...
XS_EUPXS(XS_Faidx_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_new)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Faidx_get_sequence); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_get_sequence)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Faidx_get_sequence_no_length); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_get_sequence_no_length)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "obj, location");
...
XS_EUPXS(XS_Faidx_has_sequence); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_has_sequence)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "obj, location");
...
XS_EUPXS(XS_Faidx_length); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_length)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Faidx_get_all_sequence_ids); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_get_all_sequence_ids)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Faidx_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Faidx_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "obj");
...
extern "C"
#endif
XS_EXTERNAL(boot_Faidx); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Faidx)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        (void)newXSproto_portable("Faidx::get_all_sequence_ids", XS_Faidx_get_all_sequence_ids, file, "$");
